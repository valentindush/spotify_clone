...
export default function  LandingNav(){
    ...
    return(
        <nav className={'w-full h-fit bg-black relative p-7 pl-[10%] flex items-center'}>
            <div className={'logo h-[30px] w-[200px]'}>
            ...
            <div className={'nav-links flex gap-8 items-center absolute right-[10%]'}>
                <Link className={'text-white text-md transition duration-300 hover:text-green-700'} to={'/'}>Premium</Link>
                <Link className={'text-white text-md transition duration-300 hover:text-green-700'} to={'/'}>Support</Link>
                <Link className={'text-white text-md transition duration-300 hover:text-green-700'} to={'/'}>Download</Link>
                <div className={'text-white'}>|</div>
                <div className={'profile flex gap-3 items-center'}>
                    <img className={'rounded-full w-12 h-12 object-cover'} src={testImg} alt={'profile'}/>
                    <span onClick={()=>setShowP(!showp)} className={'flex items-center text-white gap-2 cursor-pointer transition duration-300 hover:text-green-700'}>
                        <span>Profile</span>
                        <FaAngleDown color={'white'} fontSize={'1.5em'} className={'transition duration-300 hover:fill-green-700'} />
                    </span>

                    {showp === true &&
                        <div className={'absolute transition duration-300 bg-white text-left right-[-2em] p-16 pl-4 top-14 py-3 shadow-lg rounded-lg'}>
                            <Link className={'text-black text-sm mt-2 transition block duration-300 hover:text-green-700'} to={'/'}>Account</Link>
                            <Link className={'text-black text-sm mt-2 transition block duration-300 hover:text-green-700'} to={'/'}>Log out</Link>
                        </div>
                    }
                </div>
            </div>
