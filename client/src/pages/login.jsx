...
export default function Login() {
    ...
    const handleClick = async () => {
        ...
        const redirect_uri = "https://www.spotify-dush.vercel.app";
  ...
  return (
    <div className='bg-black flex flex-col items-center justify-center min-h-screen '>
        <header className=''>
            <svg className={'dark:fill-white fill-white h-[40px] relative'} viewBox="0 0 63 20" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMin meet">
        ...
        <div className='btn pt-7'>
            <a onClick={handleClick} className='text-white bg-[#1ed760] p-4 px-6 rounded-full cursor-pointer transition duration-300 block ease-in hover:scale-105 '>Login with Spotify</a>
        </div>
    </div>
  )
}
