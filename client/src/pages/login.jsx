...
export default function Login() {
    const AUTH_URL = "https://accounts.spotify.com/authorize?client_id=febafbfe1b4e40b6b002cc6f0dfaccd6&response_type=code&redirect_uri=http://localhost:3000&scope=streaming%20user-read-email%20user-read-private%20user-library-read%20user-library-modify%20user-read-playback-state%20user-modify-playback-state"
  ...
  return (
    <div className='bg-black flex flex-col items-center justify-center min-h-screen '>
        ...
        <div className='title'>
            <h2 className='text-white text-lg mt-6'>Login with your spotify account and start listening to music</h2>
        </div>
        <div className='btn pt-7'>
            <a href={AUTH_URL} className='text-white bg-[#1ed760] p-4 px-6 rounded-full transition duration-300 block ease-in hover:scale-105 '>Login with Spotify</a>
        </div>
    </div>
  )
}
